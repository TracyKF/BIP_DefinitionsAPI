...
/*
    ...
    public void apiCashierActivityReport() {
        Map<String, String> pairs;
        pairs = reportUIDsAndTitles();
        assertTrue(pairs.containsKey("fdb2a0f2-c636-4f41-a06b-57f4607c4a8c"));
        for (Map.Entry pairEntry : pairs.entrySet()) {
            if (pairEntry.getKey().equals("fdb2a0f2-c636-4f41-a06b-57f4607c4a8c")) {
                String value = (String) pairEntry.getValue();
                String key = (String) pairEntry.getKey();
                //System.out.println(key + ":  " +  pairEntry.getValue());
                assertEquals(value, "Cashier Activity Report - Payments Received", "Report Title not found.");
            }
        }
    }
    ...
    public void apiDailyAidandRefundCheckActivityFile() {
        Map<String, String> pairs;
        pairs = reportUIDsAndTitles();
        assertTrue(pairs.containsKey("0381f391-d2f9-4305-9211-4f73ef222dd9"));
        for (Map.Entry pairEntry : pairs.entrySet()) {
            if (pairEntry.getKey().equals("0381f391-d2f9-4305-9211-4f73ef222dd9")) {
                String value = (String) pairEntry.getValue();
                String key = (String) pairEntry.getKey();
                //System.out.println(key + ":  " +  pairEntry.getValue());
                assertEquals(value, "Daily Aid and Refund Check Activity File", "Report Title not found.");
            }
        }
    }
    ...
    // Archived on: 10/21/2020 1:31 PM
/*    @Test
    public void apiDegreesOrganizationAssociations() {
        Map<String, String> pairs;
        pairs = reportUIDsAndTitles();
        assertTrue(pairs.containsKey("44ea54e3-2eb5-484c-becc-94162897cd77"));
        for (Map.Entry pairEntry : pairs.entrySet()) {
            if (pairEntry.getKey().equals("44ea54e3-2eb5-484c-becc-94162897cd77")) {
                String value = (String) pairEntry.getValue();
                String key = (String) pairEntry.getKey();
                //System.out.println(key + ":  " +  pairEntry.getValue());
                assertEquals(value, "Degrees and Organization Associations", "Report Title not found.");
            }
        }
    }*/
    ...
    // Archived on 11/5/2020 8:31 AM
/*    @Test
    public void apiFiscalYearIncomeandExpenseSummaryReportMenu() {
        Map<String, String> pairs;
        pairs = reportUIDsAndTitles();
        assertTrue(pairs.containsKey("64769b8b-1d91-4661-abed-a076c3f2733d"));
        for (Map.Entry pairEntry : pairs.entrySet()) {
            if (pairEntry.getKey().equals("64769b8b-1d91-4661-abed-a076c3f2733d")) {
                String value = (String) pairEntry.getValue();
                String key = (String) pairEntry.getKey();
                //System.out.println(key + ":  " +  pairEntry.getValue());
                assertEquals(value, "Fiscal Year Income and Expense Summary Report Menu", "Report Title not found.");
            }
        }
    }
 */
    ...
    /*    @Test
        public void apiGrantandContractCertificationReport() {
            Map<String, String> pairs;
            pairs = reportUIDsAndTitles();
            assertTrue(pairs.containsKey("93ad3676-d518-40e3-a1e5-8b660519fdce"));
            for (Map.Entry pairEntry : pairs.entrySet()) {
                if (pairEntry.getKey().equals("93ad3676-d518-40e3-a1e5-8b660519fdce")) {
                    String value = (String) pairEntry.getValue(); String key = (String) pairEntry.getKey();
                    //System.out.println(key + ":  " +  pairEntry.getValue());
    ...
    /*    @Test
        public void apiPayrollCashMainPage() {
            Map<String, String> pairs;
            pairs = reportUIDsAndTitles();
            assertTrue(pairs.containsKey("bf3245a0-713e-4d10-8602-c53da294e7aa"));
            for (Map.Entry pairEntry : pairs.entrySet()) {
                if (pairEntry.getKey().equals("bf3245a0-713e-4d10-8602-c53da294e7aa")) {
                    String value = (String) pairEntry.getValue(); String key = (String) pairEntry.getKey();
                    //System.out.println(key + ":  " +  pairEntry.getValue());
                    assertEquals(value, "Hepps Payroll and GL Payroll Cash Account", "Report Title not found.");
                }
            }
        }*/
    @Test
    ...
    /*    @Test
        public void apiFECDashboardActionListLegacy() {
            Map<String, String> pairs;
            pairs = reportUIDsAndTitles();
            assertTrue(pairs.containsKey("9480881b-3187-486e-af9a-bd3cfc4c9c57"));
            for (Map.Entry pairEntry : pairs.entrySet()) {
                if (pairEntry.getKey().equals("9480881b-3187-486e-af9a-bd3cfc4c9c57")) {
                    String value = (String) pairEntry.getValue(); String key = (String) pairEntry.getKey();
                    //System.out.println(key + ":  " +  pairEntry.getValue());
                    assertEquals(value, "Legacy FEC Dashboard Action List", "Report Title not found.");
                }
            }
        }*/
/*    @Test
    public void apiGLReconcilingReport() {
        Map<String, String> pairs;
        pairs = reportUIDsAndTitles();
        assertTrue(pairs.containsKey("6c16b832-4499-4bc8-a698-552bb865db8e"));
        for (Map.Entry pairEntry : pairs.entrySet()) {
            if (pairEntry.getKey().equals("6c16b832-4499-4bc8-a698-552bb865db8e")) {
                String value = (String) pairEntry.getValue(); String key = (String) pairEntry.getKey();
                //System.out.println(key + ":  " +  pairEntry.getValue());
                assertEquals(value, "Legacy GL Payroll Cash Activities in a Month: Major Payroll Runs", "Report Title not found.");
            }
        }
    }*/
/*    @Test
    public void apiGrantandContractCertificationReportLegacy() {
        Map<String, String> pairs;
        pairs = reportUIDsAndTitles();
        assertTrue(pairs.containsKey("5e425602-e263-4558-93fd-56e6560cfa74"));
        for (Map.Entry pairEntry : pairs.entrySet()) {
            if (pairEntry.getKey().equals("5e425602-e263-4558-93fd-56e6560cfa74")) {
                String value = (String) pairEntry.getValue(); String key = (String) pairEntry.getKey();
                //System.out.println(key + ":  " +  pairEntry.getValue());
                assertEquals(value, "Legacy Grant and Contract Certification Report", "Report Title not found.");
            }
        }
    }*/
    @Test
...
/*    @Test
    public void apiMyFDExpenseTransferVolumeReport() {
        Map<String, String> pairs;
        pairs = reportUIDsAndTitles();
        assertTrue(pairs.containsKey("4ad810ad-2a9e-4ee5-9f15-847ccc6f5770"));
        for (Map.Entry pairEntry : pairs.entrySet()) {
    ...
    //archived on 9/24/2020 10:19 AM
/*    @Test
    public void apiStudentAthletesEarning() {
        Map<String, String> pairs;
        pairs = reportUIDsAndTitles();
        assertTrue(pairs.containsKey("b3898a82-318a-4ebf-81f5-911b60a059a3"));
        for (Map.Entry pairEntry : pairs.entrySet()) {
            if (pairEntry.getKey().equals("b3898a82-318a-4ebf-81f5-911b60a059a3")) {
                String value = (String) pairEntry.getValue();
                String key = (String) pairEntry.getKey();
                //System.out.println(key + ":  " +  pairEntry.getValue());
                assertEquals(value, "Student Athletes Earning", "Report Title not found.");
            }
        }
    }*/
    ...
    /*    @Test
        public void apiUseTaxBienniumSummary() {
            Map<String, String> pairs;
            pairs = reportUIDsAndTitles();
            assertTrue(pairs.containsKey("2fecd537-683f-4095-93a0-86de8b553ca6"));
            for (Map.Entry pairEntry : pairs.entrySet()) {
                if (pairEntry.getKey().equals("2fecd537-683f-4095-93a0-86de8b553ca6")) {
                    String value = (String) pairEntry.getValue(); String key = (String) pairEntry.getKey();
                    //System.out.println(key + ":  " +  pairEntry.getValue());
                    assertEquals(value, "Use Tax Liability Biennium Summaries", "Report Title not found.");
                }
            }
        }*/
    @Test
